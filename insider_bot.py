...
# --- Quality Filters (from backtest) ---
MAX_FILING_DELAY = 30  # days
MIN_PRICE = 1.00
MAX_PRICE = 10000
MIN_BOT_PRICE = 10.00
...
def process_filings(filings, target_date):
    ...
    for filing in filings:
        ...
        try:
            ...
            for tx in transactions:
                ...
                # Layer 4: Filing delay validation
                ...
                if price >= MIN_BOT_PRICE and value >= MIN_BOT_VALUE:
                    ...
                    # FIX: Filter out "NONE" tickers (bad data from SEC)
    ...
    if stats['bad_ticker'] > 0:
        logger.info(f"Filtered out {stats['bad_ticker']} 'NONE' tickers")
